                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body collapse in"> 
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12"> 
                                ...
                                <div class="col-xs-4 col-sm-4 col-md-4 form-group" ng-bind-html="speciality" ></div>
                                <div class="col-xs-4 col-sm-4 col-md-4 form-group">
                                    <button type="button" onclick="return doctorSearch();" class="btn btn-default hidden-xs">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12"> 
                                    <div class="col-xs-4 col-sm-4 col-md-4 form-group"  ng-repeat="doctor in doctors"> 
                                       ...
                                       <img ng-if="doctor.avatar ==''" src="<?php echo base_url(); ?>assets/img/doctor/avatar1.jpg"  width="100" height="100">
                                        ...
                                        <p style="">Experience : 25 Years</p>
                                        <p style="">Apollo Cradle Nehru Place New Delhi</p>
                                        <p style="font-size: 12px;">MON - SAT | 8:00 AM - 1:00 PM, 1:00 PM - 2:00 PM</p>
                                        <div class="row">
                                            <div class="col-xs-8 col-sm-9 col-md-8">
                                                <p class="rd_more margintop10"><a href="{{doctor.id}}"><i class="fa fa-eye"></i> View Profile</a></p>
                                            </div>
