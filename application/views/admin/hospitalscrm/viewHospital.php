    ...
    <div class="col-sm-12">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h5 style="color:#ffffff"><i class="fa fa-user"></i> {{hosPitaledit['hospital'][0].name}} </h5>                  
            </div>
            ...
            <div class="row mt20">
              <div class="col-xs-12 col-sm-6 col-md-6 mt20">
                  ...
                  <p><b>Status:</b>     
                     ...
                     <span ng-if="hosPitaledit['hospital'][0].status==='0'">
                       New
                    </span>
                      <span ng-if="hosPitaledit['hospital'][0].status==='1'">
                       In Progress
                    </span>
                      <span ng-if="hosPitaledit['hospital'][0].status==='2'">
                      Confirmed
                    </span>
