                ...
                <div class="col-md-6">  
                  <div class="form-group">
                    ...
                    <label>First Name*</label>
                      <input type="text" class="form-control col-md-8" name="firstname" value="<?php echo $firstname; ?>" id="" placeholder="First Name" required="required">
                    </div>
                  </div>
                </div>
                <div class="col-md-6">  
                ...
                <div class="col-md-6">  
                 ...
                 <div class="col-md-6">  
                   <div class="form-group">
                    <div class="col-md-12">
                    <label>Email*</label>
                      <input type="text" class="form-control col-md-8" name="email" value="<?php echo $email; ?>" id="" placeholder="Email" required="required">
                    </div>
                  </div>
                 </div>
                 <div class="col-md-6">  
                   <div class="form-group">
                    <div class="col-md-12">
                    <label>Phone*</label>
                      <input type="text" class="form-control col-md-8" name="phone" value="<?php echo $phone; ?>" id="" placeholder="Phone" required="required">
                    </div>
                  </div>
                 </div>
                 <div class="col-md-6">  
