...
<div class="mi_filterdata">
   <div class="mi_filterdatabox mi-lt-grey mb10 wow fadeInUp">
	  ...
	  <div class="mi_hospitalinformation"> 
              <div class="mi_hospitalinformationbox"> <i class="mi_chaticon"></i> 
                  <div class="mi_hospitalinformationbox-in">27 Feedback</div> 
              </div>
              <div class="mi_hospitalinformationbox"> <i class="mi_timeicon"></i> 
                  <div class="mi_hospitalinformationbox-in">Mon - Sat <br/>
                      8:30am to 1:30pm ,  5:00pm to 8:00pm </div>
              </div>
              <div class="mi_hospitalinformationbox"> <i class="mi_addressicon"></i> 
                  <div class="mi_hospitalinformationbox-in">Tower A, Unitech Business Park,
                      Block - F, South City 1, Sector - 41 </div>
