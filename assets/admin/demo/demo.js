...
function stform() {    
    var stf = document.getElementById("subnav_aktiv");
    var stficon = document.getElementById("stf_icon");    
    if(stf.value=="1"){
        stf.value = "0";
        stficon.className = "fa fa-toggle-off fa-off";
        $("#subnav_form").slideToggle('fast');
    }else{
        stf.value = "1";
        stficon.className = "fa fa-toggle-on fa-on";
        $("#subnav_form").slideToggle();
    }    
}


function zaehle_title()
{
formfeld=window.document.editor.Titel.value;
window.document.editor.anzeigen_title.value=window.document.editor.Titel.value.length;
}

function zaehle_beschreibung()
{
formfeld=window.document.editor.beschreibung.value;
window.document.editor.anzeigen_beschreibung.value=window.document.editor.beschreibung.value.length;
}

function goto(){
var URL = document.getElementById("goto").options[document.getElementById("goto").selectedIndex].value;
